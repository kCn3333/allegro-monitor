...
function offerCard(listing: Listing & { monitorId: number; monitorName: string; firstSeenAt: string }): string {
...
export function renderPage(monitors: Monitor[], listings: Array<Listing & { monitorId: number; monitorName: string; firstSeenAt: string }>, exclusions: MonitorExclusion[]): string {
